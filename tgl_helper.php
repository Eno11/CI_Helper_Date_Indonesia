...
function date_indo_1 ($params) {
	if ($params !== null) {
		$newdate = substr($params,8,2).'-'.substr($params,5,2).'-'.substr($params,0,4);
		return $newdate; // 01-01-2000
	}
}

function date_indo_2($date)
{
	$tgl=substr($date,8,2);
	$bln=substr($date,5,2);
...
function date_indo_3($tgl = FALSE)
{
...
function date_indo_month_1($bln)
{
...
function date_indo_month_2($bln)
{
...
function date_romawi_month($bln)
{
...
function date_indo_time_1 ($params) {
	if ($params !== null) {
		$newdate = substr($params, 11,5);
		return $newdate; // 12:00
	}
}

function date_indo_time_2 ($params) {
	if ($params !== null) {
		$newdate = substr($params, 11,8);
		return $newdate; // 12:00:00
	}
}

function date_time_server()
{
